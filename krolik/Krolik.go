...
// Krolik to prosty klient RabbitaMQ.
type Krolik struct {
	ex  string        // nazwa głównego exchangera
	dlx string        // nazwa Dead-Letter-eXchangera
	ch  *amqp.Channel // kanał do komunikacji z Rabbitem
}

// MusiKrolik tworzy połączenie z RabbitMQ i exchanger.
func MusiKrolik(krolikURL, krolikEX string) *Krolik {
